...
export default function CardGrid() {
    ...
    let sections: car[] = [
        { id: 'e30', aspectRatio: 0.408, originalYOffset: 50, originalYHeight: 186 },
        { id: 'rs7', aspectRatio: 0.5, originalYHeight: 500, originalYOffset: 10 },
        ...
        <div className="grid grid-cols-1 min-h-screen grid-rows-3 bg-black">
            <div onMouseOver={() => onHover("e30")} onMouseLeave={() => { onLeave("e30") }} className="h-1/3 overflow-hidden relative">
                ...
                <svg id='svge30' className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" viewBox="0 0 451 185" width="455" height="186" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <circle strokeDasharray={1000} strokeDashoffset={1000} className="pathe30" filter="url(#blurFilter)" cx="152" cy="99" r="16" fill="none" strokeWidth="2" stroke="lightblue"></circle>
                    <circle strokeDasharray={1000} strokeDashoffset={1000} className="pathe30" filter="url(#blurFilter)" cx="118" cy="98" r="15" fill="none" strokeWidth="2" stroke="lightblue"></circle>
                    <circle strokeDasharray={1000} strokeDashoffset={1000} className="pathe30" filter="url(#blurFilter)" cx="343" cy="98" r="15" fill="none" strokeWidth="2" stroke="lightblue"></circle>
                    <circle strokeDasharray={1000} strokeDashoffset={1000} className="pathe30" filter="url(#blurFilter)" cx="310" cy="99" r="16" fill="none" strokeWidth="2" stroke="lightblue"></circle>
                    <circle strokeDasharray={1000} strokeDashoffset={1000} className="pathe30" cx="152" cy="99" r="16" fill="none" strokeWidth="2" stroke="lightblue"></circle>
                    <circle strokeDasharray={1000} strokeDashoffset={1000} className="pathe30" cx="118" cy="99" r="15" fill="none" strokeWidth="2" stroke="lightblue"></circle>
                    <circle strokeDasharray={1000} strokeDashoffset={1000} className="pathe30" cx="343" cy="99" r="15" fill="none" strokeWidth="2" stroke="lightblue"></circle>
                    <circle strokeDasharray={1000} strokeDashoffset={1000} className="pathe30" cx="310" cy="99" r="16" fill="none" strokeWidth="2" stroke="lightblue"></circle>
