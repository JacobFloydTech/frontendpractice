...
export default function MonsterCatFooter() {


    return (
        <div className="flex flex-col mb-8 w-3/4 mx-auto">
            <div className="flex flex-row">
                <p className="text-white w-full">2011 - 2023 © Monstercat, All Rights Reserved</p>
