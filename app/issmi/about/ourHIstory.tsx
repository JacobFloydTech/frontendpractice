        ...
        <div className="flex w-full h-auto flex-col">
            ...
            <div className="flex flex-col mx-12 bg-[#183029] text-white">
                ...
                <div className="historyGrid">
                    ...
                    <div className="flex  justify-around flex-col mt-60">
                    ...
                    <div className=" flex justify-around flex-col">
                        ...
                        <div className="flex flex-col space-y-4">
                            <p className="w-2/3 font-semibold text-2xl">2021</p>
                            <p className="w-2/3 text-left text-lg">ISSIMI Factory begins collaborations with prestigious car manufacturers Koenigsegg and Rimac, reflecting our commitment to full car collection services. As our reputation for quality and transparency continues to spread, revenue grows 63% from the previous year.  </p>
                            <p className="w-2/3 text-left text-lg">McLaren F1 transacts on our marketplace, from UK to California.</p>
                        </div>
                        <div className="flex flex-col space-y-4">
...
function HistorySVG() {
    return (
        <svg height='100%' width='100%' preserveAspectRatio="none" viewBox='0 0 50 460' xmlns="http://www.w3.org/2000/svg">
            ...
            <line x1="50%" x2="50%" y1="216" y2="298" stroke='#4C665E' stroke-width="3" />
            <circle stroke='#4C665E' stroke-width="3" cx="50%" cy="305" r="8" fill="none" />
            <line x1="50%" x2="50%" y1="312" y2="362" stroke='#4C665E' stroke-width="3" />
            <circle stroke='#4C665E' stroke-width="3" cx="50%" cy="369" r="8" fill="none" />
            <line x1="50%" x2="50%" y1="377" y2="451" stroke='#4C665E' stroke-width="3" />
            <line x1='50%' x2='25%' y1='451' y2='420' stroke='#4C665E' stroke-width='3' />
            <line x1='50%' x2='75%' y1='451' y2='420' stroke='#4C665E' stroke-width='3' />
        </svg>
    )
}